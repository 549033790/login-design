...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_tologin=findViewById(R.id.btnLinkToLoginScreen);
    ...
    class registerTask extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            button_login=findViewById(R.id.btnLogin);
            button_tosignup=findViewById(R.id.btnLinkToRegisterScreen);
            button_tosignup.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    setContentView(R.layout.layout_register);
                }
